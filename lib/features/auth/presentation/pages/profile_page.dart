...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    developer.log('ProfilePage build, profile: ${profile?.uid}', name: 'ProfilePage');
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column( // Use Column for ID Card layout
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Stack( // Use Stack to place edit button over avatar
                                children: [
                                  Container(
                                    decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      boxShadow: [// Add box shadow for depth
                                        BoxShadow(
                                  ...
                                  if (profile != null) // Only show edit button if profile is not null
                                    Positioned(
                                       bottom: 0,
                                       right: 0,
                                       child: InkWell(
                                         onTap: () {
                                            developer.log('Edit button tapped, profile: ${profile.uid}', name: 'ProfilePage');
                                            _showEditProfileDialog(profile); // Now we are sure profile is not null
                                         },
                                         child: Container(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      profile?.name ?? 'N/A',
                                      style: Theme.of(context).textTheme.titleLarge, // Use titleLarge for name
                                    ),
                                    ...
                                    if (profile?.username != null && profile!.username!.isNotEmpty)
                                      Row(
                                        children: [
                                          Icon(Icons.alternate_email_outlined, size: 18, color: Theme.of(context).colorScheme.primary),
                   ...
                   ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Theme.of(context).colorScheme.error, // Use error color for danger action
                      foregroundColor: Theme.of(context).colorScheme.onError, // Text color
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: authProvider.isLoading ? null : () => _saveProfile(context), // Pass context
           style: ElevatedButton.styleFrom(
