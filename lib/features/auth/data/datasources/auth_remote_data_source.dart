...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  Future<UserModel> signInWithGoogle() async {
    try {
      ...
      if (googleUser == null) {
        throw ServerException('Google Sign In cancelled.'); // Or a custom AuthException
      }

      // Obtain the auth details from the request
      final GoogleSignInAuthentication googleAuth = await googleUser.authentication; // Correct access
      ...
      throw ServerException(e.message ?? 'An unknown error occurred during Google Sign In.');
    } catch (e) {
      throw ServerException(e.toString());
    }
  }
